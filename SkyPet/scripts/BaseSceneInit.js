...
function initScene()
{
	...
	// CAMERA
	camera = new THREE.PerspectiveCamera(cameraFov, width / height, 50, 10000);
	...
	objectOne = new ObjClass();
	objectTwo = new ObjClass();

	objectOne.items[0] = "two";
	objectTwo.test();
	console.log(objectOne.items[0]);
